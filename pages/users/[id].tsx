...
import { getServers } from "../../utility/authlink";
...
export const getServerSideProps: GetServerSideProps = async ({ req, params }) => {
    ...
    const sessionUser = (await getSession({ req }))?.user as ModifiedSession;
    let servers;
    if (sessionUser.accessToken) servers = await getServers(sessionUser.accessToken);
    console.log(servers);
